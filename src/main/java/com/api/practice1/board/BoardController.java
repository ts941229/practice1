...
public class BoardController {
	...
	public String boardListForm(Model model, @PageableDefault(page = 0, size = 5) Pageable pageable, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "page", required = false) Integer page) {
		...
		System.out.println("boardListSize : "+boardList.getContent().size());
